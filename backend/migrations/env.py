"""Alembic environment for the optional synchronous PostgreSQL store."""
...
def run_migrations_offline() -> None:
    """Render PostgreSQL SQL without requiring a database connection."""
    context.configure(
...
def run_migrations_online() -> None:
    """Run migrations through a synchronous psycopg 3 SQLAlchemy engine."""
